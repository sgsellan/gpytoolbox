...
S, F = gpytoolbox.metropolis_hastings(unnorm_distr,next_sample,np.array([0.1]),100000)
...
S, F = gpytoolbox.metropolis_hastings(unnorm_distr,next_sample,np.array([0.1,0.1]),100000)
plot2 = plt.figure(2)
